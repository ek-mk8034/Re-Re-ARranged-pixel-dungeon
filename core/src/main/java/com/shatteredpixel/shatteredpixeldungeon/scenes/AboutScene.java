...
public class AboutScene extends PixelScene {
	...
	public void create() {
		...
		CreditsBlock arranged = new CreditsBlock(true, Window.WHITE,
				"Re-ReARranged Pixel Dungeon",
				Icons.ARRANGED.get(),
				"Developed by: _Eric Kim_\nA fork based on the open-source projects:\n_Shattered Pixel Dungeon_ and _ARranged Pixel Dungeon_.",
				"github repository",
				"https://github.com/ek-mk8034/Re-rearranged-pixel-dungeon");
		...
		CreditsBlock arpd = new CreditsBlock(true, Window.TITLE_COLOR,
				"ARranged Pixel Dungeon",
				Icons.ARRANGED.get(),
				"Developed by: _Hot_Mocha_\nBased on Shattered Pixel Dungeon's open source",
				"github.com/Hoto-Mocha/Re-ARranged-Pixel-Dungeon",
				"https://github.com/Hoto-Mocha/Re-ARranged-Pixel-Dungeon");
		arpd.setRect(arranged.left(), arranged.bottom() + 12, colWidth, 0);
		content.add(arpd);

		// Hero Splash Art (ARPD 아래 / 중앙정렬)
		...
		splash.setPos(
				arranged.left() + (fullWidth - splash.width()) / 2f,
				arpd.bottom() + 6
		);
		content.add(splash);

		addLine(splash.bottom() + 4, content);
		...
		shpx.setRect(arranged.left(), splash.bottom() + 12, colWidth, 0);
		content.add(shpx);
		...
		if (landscape()) {
			...
			cube.setPos(w / 2f - colWidth / 2f, wata.bottom() + 5);
		}
		content.add(cube);
		...
		CreditsBlock gdx = new CreditsBlock(true, GDX_COLOR,
				"libGDX",
				Icons.LIBGDX.get(),
